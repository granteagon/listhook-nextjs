          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-blue-900 mb-3">2.1 Personal Information</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-blue-900 mb-3">2.2 Automatically Collected Information</h3>
                  <p className="text-gray-600 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-blue-900 mb-4">4. Information Sharing</h2>
