      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-blue-900 mb-4">3. User Accounts</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-blue-900 mb-4">4. Payment Terms</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-blue-900 mb-4">5. Content Guidelines</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-blue-900 mb-4">6. Termination</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-blue-900 mb-4">8. Contact Information</h2>
              <p className="text-gray-600 leading-relaxed mb-3">
              ...
              <div className="ml-4 space-y-2 text-gray-600">
                <p>
                  ...
                  <a href="mailto:legal@listhook.com" className="text-blue-600 hover:underline">
                    legal@listhook.com
                  </a>
                </p>
                <p>
